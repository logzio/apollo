...
public class OpeningExecTest
{
    ...
    public void test() throws Exception {
        ...
        ApolloWebSocketListener apolloWebSocketListener = new ApolloWebSocketListener();
        ApolloWebSocketClient apolloWebSocketClient = standaloneApollo.createTestWebSocketClient(apolloWebSocketListener);
        ...
        Thread.sleep(10 * 100);
        apolloWebSocketListener.getFailedSessionCounter();
        System.out.println("tahat");
    }
